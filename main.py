...
logo_img = get_img_as_base64("logo1.png")
st.set_page_config(page_title="LeafLoom", page_icon="logo1.png")
...
with st.sidebar:
    ...
    st.markdown('<p class="big-2-font">LeafLoom</p>', unsafe_allow_html=True)

    st.markdown('<p class="small-font">Developed by<br>Vaibhav & Anushka\n</p>', unsafe_allow_html=True)
